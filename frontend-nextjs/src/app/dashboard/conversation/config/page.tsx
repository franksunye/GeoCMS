...
type ScoringRule = {
  ...
  conditions: string // Simplified for now
  score: number
  weight: number
  createdAt: string
  updatedAt: string
...
const mockRules: ScoringRule[] = [
  ...
  },
  {
    ...
    appliesTo: 'Calls',
    description: 'Flag calls with price objections',
    active: true,
    ruleType: 'Automatic',
    conditions: 'Tag: price_objection',
    score: 60,
    weight: 0.8,
    createdAt: '2025-12-02',
    updatedAt: '2025-12-02',
...
export default function ConversationConfigPage() {
  ...
  // Rule form state
  const [ruleForm, setRuleForm] = useState({ name: '', description: '', conditions: '', score: 50, weight: 1.0, active: true })
            ...
            <table className="w-full">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase">Applies To</th>
              ...
              <tbody className="divide-y divide-gray-200">
                {rules.map((rule) => (
                  <tr key={rule.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 text-sm text-gray-600">{rule.appliesTo}</td>
                    <td className="px-6 py-4 text-sm">
                      <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-purple-100 text-purple-800">
                        {rule.ruleType}
                      </span>
                    </td>
                    <td className="px-6 py-4 text-sm font-mono text-gray-900">{rule.score}</td>
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <div className="px-6 py-4 space-y-4">
              <div>
                ...
                <input
                  type="text"
                  placeholder="e.g., High Intent Score"
                  className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
              ...
              <div>
                ...
                <textarea
                  rows={3}
                  placeholder="e.g., Tag: intent_positive AND Execution Score > 70"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    max={100}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                    defaultValue={selectedRule?.score || 50}
                  />
                </div>
                <div>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-md p-3">
                <p className="text-xs text-blue-800">
                  <strong>💡 Tip:</strong> Use the Preview button to test this rule against sample data before saving.
                </p>
              </div>
            </div>
      ...
      {showRulePreview && selectedRule && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4">
            <div className="px-6 py-4 border-b border-gray-200">
              <h3 className="text-lg font-semibold text-gray-900">Rule Preview: {selectedRule.name}</h3>
            ...
            <div className="px-6 py-4 space-y-4">
              <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                ...
                <code className="text-xs text-gray-700 block p-2 bg-white border border-gray-300 rounded">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                  ...
                  <p className="text-2xl font-bold text-blue-900 mt-1">{selectedRule.score}</p>
                </div>
                <div className="bg-purple-50 rounded-lg p-4 border border-purple-200">
                  <p className="text-xs text-purple-600 font-medium uppercase">Weight</p>
                  <p className="text-2xl font-bold text-purple-900 mt-1">{selectedRule.weight.toFixed(1)}x</p>
                </div>
              </div>
              <div className="bg-yellow-50 rounded-lg p-4 border border-yellow-200">
                <p className="text-sm text-yellow-800">
                  <strong>⚠️ Note:</strong> Preview functionality requires backend integration. This mock shows rule configuration.
                </p>
              </div>
            </div>
            <div className="px-6 py-4 border-t border-gray-200 flex gap-2 justify-end">
